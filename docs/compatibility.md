...
| 项目 | 版本 |
|---|---|
| Cursor | **`3.9.16`**（推荐；维护与 CI 测试基准） |
| VS Code 内核 | `1.105.1` |
| 官方中文语言包 | `1.105.0` |
| 平台 | Windows |

> **建议**：请优先使用**已验证的最新 Cursor 版本**（当前为 `3.9.16`），以获得更完整的汉化与更少的英文遗漏。较旧版本（例如 `3.9.8` 及更早的 `3.8.x`）不再作为维护基准，部分 embedded patch 与 Glass 锚点可能无法命中。
