...
const CRITICAL_EMBEDDED_UI_PATCHES = [
  ...
  {
    from: 'onDidChangeCache(()=>{h.dispose(),this._notificationService.prompt(ra.Error,x(12811,null),[{label:x(12812,null),run:()=>this._hostService.reload()}])})',
    to: 'onDidChangeCache(()=>{h.dispose()})',
  },
  {
    from: 'onDidChangeCache(()=>{p.dispose(),this._notificationService.prompt(Fo.Error,C(12811,null),[{label:C(12812,null),run:()=>this._hostService.reload()}])})',
    to: 'onDidChangeCache(()=>{p.dispose()})',
  },
  {
